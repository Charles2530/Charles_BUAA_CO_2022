...
xst -ifn xst.scr
move Clock_IP_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_IP_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_IP_exdes.ucf Clock_IP_exdes

echo 'Running map'
map -timing -pr b Clock_IP_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock_IP_exdes -w routed.ncd routed.v
cd ..
