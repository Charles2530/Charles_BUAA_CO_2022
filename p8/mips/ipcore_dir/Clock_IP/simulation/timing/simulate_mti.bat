...
vlog -work work Clock_IP_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax Clock_IP_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.Clock_IP_tb work.glbl
