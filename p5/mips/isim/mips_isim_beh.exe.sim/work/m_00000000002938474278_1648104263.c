...
LAB24:    xsi_set_current_line(71, ng0);
    ...
    t2 = (t0 + 2968U);
    t3 = *((char **)t2);
    xsi_vlogtype_sign_extend(t6, 32, t3, 2);
    t2 = ((char*)((ng1)));
    memset(t20, 0, 8);
    xsi_vlog_signed_greater(t20, 32, t6, 32, t2, 32);
    t4 = (t20 + 4);
    t7 = *((unsigned int *)t4);
    t8 = (~(t7));
    t9 = *((unsigned int *)t20);
...
LAB28:    xsi_set_current_line(89, ng0);
    ...
    t5 = ((char*)((ng3)));
    memset(t27, 0, 8);
    xsi_vlog_unsigned_minus(t27, 32, t12, 2, t5, 32);
    t13 = (t0 + 6248);
    xsi_vlogvar_wait_assign_value(t13, t27, 0, 0, 2, 0LL);
    goto LAB27;

}


extern void work_m_00000000002938474278_1648104263_init()
{
	static char *pe[] = {(void *)Always_47_0};
	xsi_register_didat("work_m_00000000002938474278_1648104263", "isim/mips_isim_beh.exe.sim/work/m_00000000002938474278_1648104263.didat");
