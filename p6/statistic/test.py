...
# 各类指令出现频率设置
f_all = 1
f_R = 5*random.randint(1, 4)*f_all
f_I = 5*random.randint(1, 4)*f_all
f_L = 10*random.randint(1, 4)*f_all
f_S = 10*random.randint(1, 4)*f_all
f_B = 1*random.randint(1, 4)*f_all
f_J = 1*random.randint(1, 4)*f_all
f_md = 5*random.randint(1, 4)*f_all
f_mf = 5*random.randint(1, 4)*f_all
    ...
    def main(self):
        ...
        if sel in range(0, f_R*R_num):
            ...
            if self.list[2] == 'lb' or self.list[2] == 'lbu':
                ...
                self.code = self.list[2] + ' ' + '$' + \
                    str(self.rt) + ',' + str(self.mem << 1) + \
                    '(' + '$' + '0' + ')'+'\n'
            else:
                self.code = self.list[2] + ' ' + '$' + \
                    str(self.rt) + ',' + str(self.mem << 2) + \
                    '(' + '$' + '0' + ')'+'\n'
